...
# For M368K HW3, § 10.1 Number 10
# Written in GNU Octave
#
# Description: Finds the fixed point given some x equations, this time
# using a Gauss-Seidel method
#
# **** WARNING ****
...
function x = fixedptgs(x, x1, x2, x3, n)
